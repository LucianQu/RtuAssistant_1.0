...
public class Answer_92  extends ProtocolSupport{
	
	private static String tag = Answer_92.class.getName() ;
	...
	public RtuData parse(String rtuId, byte[] b, ControlProtocol cp, String dataCode) throws Exception {
		...
		Log.i(tag, "分析<遥控启动水泵或阀门/闸门>应答: RTU ID=" + rtuId + " 数据：" + d.getSubData().toString());
		return d;
	}
