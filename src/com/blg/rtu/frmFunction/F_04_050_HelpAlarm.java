...
public class F_04_050_HelpAlarm {
	
	protected MainActivity act ;
	protected Resources rs  ;
	
	public F_04_050_HelpAlarm(MainActivity act){
		this.act = act ;
	...
	public Node initNode(){
		...
		int alarm01 = p.getInt(Constant.func_vk_04_050_alarm_ + "01") ;
		int alarm02 = p.getInt(Constant.func_vk_04_050_alarm_ + "02") ;
		int alarm03 = p.getInt(Constant.func_vk_04_050_alarm_ + "03") ;
		int alarm04 = p.getInt(Constant.func_vk_04_050_alarm_ + "04") ;
		int alarm05 = p.getInt(Constant.func_vk_04_050_alarm_ + "05") ;
		int alarm06 = p.getInt(Constant.func_vk_04_050_alarm_ + "06") ;
		int alarm07 = p.getInt(Constant.func_vk_04_050_alarm_ + "07") ;
		int alarm08 = p.getInt(Constant.func_vk_04_050_alarm_ + "08") ;
		int alarm09 = p.getInt(Constant.func_vk_04_050_alarm_ + "09") ;
		int alarm10 = p.getInt(Constant.func_vk_04_050_alarm_ + "10") ;
		int alarm11 = p.getInt(Constant.func_vk_04_050_alarm_ + "11") ;
		int alarm12 = p.getInt(Constant.func_vk_04_050_alarm_ + "12") ;
		int alarm13 = p.getInt(Constant.func_vk_04_050_alarm_ + "13") ;
		int alarm14 = p.getInt(Constant.func_vk_04_050_alarm_ + "14") ;
	...
	public Node createNode(int alarm01, int alarm02, int alarm03, int alarm04, int alarm05, int alarm06, int alarm07, int alarm08, int alarm09, int alarm10, int alarm11, int alarm12, int alarm13, int alarm14){
		...
		Preferences p = Preferences.getInstance() ;
		p.putInt(Constant.func_vk_04_050_alarm_ + "01", alarm01) ;
		p.putInt(Constant.func_vk_04_050_alarm_ + "02", alarm02) ;
		p.putInt(Constant.func_vk_04_050_alarm_ + "03", alarm03) ;
		p.putInt(Constant.func_vk_04_050_alarm_ + "04", alarm04) ;
		p.putInt(Constant.func_vk_04_050_alarm_ + "05", alarm05) ;
		p.putInt(Constant.func_vk_04_050_alarm_ + "06", alarm06) ;
		p.putInt(Constant.func_vk_04_050_alarm_ + "07", alarm07) ;
		p.putInt(Constant.func_vk_04_050_alarm_ + "08", alarm08) ;
		p.putInt(Constant.func_vk_04_050_alarm_ + "09", alarm09) ;
		p.putInt(Constant.func_vk_04_050_alarm_ + "10", alarm10) ;
		p.putInt(Constant.func_vk_04_050_alarm_ + "11", alarm11) ;
		p.putInt(Constant.func_vk_04_050_alarm_ + "12", alarm12) ;
		p.putInt(Constant.func_vk_04_050_alarm_ + "13", alarm13) ;
		p.putInt(Constant.func_vk_04_050_alarm_ + "14", alarm13) ;
	...
	public void removeNode(LinearLayout contain, Node node){
		...
		Preferences p = Preferences.getInstance() ;
		p.remove(Constant.func_vk_04_050_alarm_ + "01" ) ;
		p.remove(Constant.func_vk_04_050_alarm_ + "02" ) ;
		p.remove(Constant.func_vk_04_050_alarm_ + "03" ) ;
		p.remove(Constant.func_vk_04_050_alarm_ + "04" ) ;
		p.remove(Constant.func_vk_04_050_alarm_ + "05" ) ;
		p.remove(Constant.func_vk_04_050_alarm_ + "06" ) ;
		p.remove(Constant.func_vk_04_050_alarm_ + "07" ) ;
		p.remove(Constant.func_vk_04_050_alarm_ + "08" ) ;
		p.remove(Constant.func_vk_04_050_alarm_ + "09" ) ;
		p.remove(Constant.func_vk_04_050_alarm_ + "10" ) ;
		p.remove(Constant.func_vk_04_050_alarm_ + "11" ) ;
		p.remove(Constant.func_vk_04_050_alarm_ + "12" ) ;
		p.remove(Constant.func_vk_04_050_alarm_ + "13" ) ;
		p.remove(Constant.func_vk_04_050_alarm_ + "14" ) ;
	}
