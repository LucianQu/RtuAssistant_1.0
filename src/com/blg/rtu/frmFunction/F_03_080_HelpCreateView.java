...
public class F_03_080_HelpCreateView {
	...
	public F_03_080_HelpCreateView(F_03_080 fr){
		this.fr = fr ;
	}
	...
	public void findView(View view){
		...
		fr.cb15 = (CheckBox)view.findViewById(R.id.f_item_cb_15); 
		
		
		fr.item01 = (EditText)view.findViewById(R.id.f_03_080_item01); 
		fr.item02 = (EditText)view.findViewById(R.id.f_03_080_item02); 
		fr.item03 = (EditText)view.findViewById(R.id.f_03_080_item03); 
		fr.item04 = (EditText)view.findViewById(R.id.f_03_080_item04); 
		fr.item05 = (EditText)view.findViewById(R.id.f_03_080_item05); 
		fr.item06 = (EditText)view.findViewById(R.id.f_03_080_item06); 
		fr.item07 = (EditText)view.findViewById(R.id.f_03_080_item07); 
		fr.item08 = (EditText)view.findViewById(R.id.f_03_080_item08); 
		fr.item09 = (EditText)view.findViewById(R.id.f_03_080_item09); 
		fr.item10 = (EditText)view.findViewById(R.id.f_03_080_item10); 
		fr.item11 = (EditText)view.findViewById(R.id.f_03_080_item11); 
		fr.item12 = (EditText)view.findViewById(R.id.f_03_080_item12); 
		fr.item13 = (EditText)view.findViewById(R.id.f_03_080_item13); 
		fr.item14 = (EditText)view.findViewById(R.id.f_03_080_item14); 
		fr.item15 = (EditText)view.findViewById(R.id.f_03_080_item15); 
	}
	...
	public void setFilter(){
		...
		fr.item01.addTextChangedListener(new MyTextWatcher(Constant.func_vk_03_080_item_01));
		fr.item02.setFilters(inFilt);
		fr.item02.addTextChangedListener(new MyTextWatcher(Constant.func_vk_03_080_item_02));
		fr.item03.setFilters(inFilt);
		fr.item03.addTextChangedListener(new MyTextWatcher(Constant.func_vk_03_080_item_03));
		fr.item04.setFilters(inFilt);
		fr.item04.addTextChangedListener(new MyTextWatcher(Constant.func_vk_03_080_item_04));
		fr.item05.setFilters(inFilt);
		fr.item05.addTextChangedListener(new MyTextWatcher(Constant.func_vk_03_080_item_05));
		fr.item06.setFilters(inFilt);
		fr.item06.addTextChangedListener(new MyTextWatcher(Constant.func_vk_03_080_item_06));
		fr.item07.setFilters(inFilt);
		fr.item07.addTextChangedListener(new MyTextWatcher(Constant.func_vk_03_080_item_07));
		fr.item08.setFilters(inFilt);
		fr.item08.addTextChangedListener(new MyTextWatcher(Constant.func_vk_03_080_item_08));
		fr.item09.setFilters(inFilt);
		fr.item09.addTextChangedListener(new MyTextWatcher(Constant.func_vk_03_080_item_09));
		fr.item10.setFilters(inFilt);
		fr.item10.addTextChangedListener(new MyTextWatcher(Constant.func_vk_03_080_item_10));
		fr.item11.setFilters(inFilt);
		fr.item11.addTextChangedListener(new MyTextWatcher(Constant.func_vk_03_080_item_11));
		fr.item12.setFilters(inFilt);
		fr.item12.addTextChangedListener(new MyTextWatcher(Constant.func_vk_03_080_item_12));
		fr.item13.setFilters(inFilt);
		fr.item13.addTextChangedListener(new MyTextWatcher(Constant.func_vk_03_080_item_13));
		fr.item14.setFilters(inFilt);
		fr.item14.addTextChangedListener(new MyTextWatcher(Constant.func_vk_03_080_item_14));
		fr.item15.setFilters(inFilt);
		fr.item15.addTextChangedListener(new MyTextWatcher(Constant.func_vk_03_080_item_15));
		...
		fr.item15.setInputType(InputType.TYPE_CLASS_NUMBER);
