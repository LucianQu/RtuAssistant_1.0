...
public class F_04_030_HelpCreateView {
	...
	public F_04_030_HelpCreateView(F_04_030 fr){
		this.fr = fr ;
	}
	...
	public void findView(View view){
		...
		fr.item01 = (EditText)view.findViewById(R.id.func_04_030_item01); 
		fr.item02 = (EditText)view.findViewById(R.id.func_04_030_item02); 
		fr.item03 = (EditText)view.findViewById(R.id.func_04_030_item03); 
		fr.item04 = (EditText)view.findViewById(R.id.func_04_030_item04); 
		fr.item05 = (EditText)view.findViewById(R.id.func_04_030_item05); 
		fr.item06 = (EditText)view.findViewById(R.id.func_04_030_item06); 
		fr.item07 = (EditText)view.findViewById(R.id.func_04_030_item07); 
		fr.item08 = (EditText)view.findViewById(R.id.func_04_030_item08); 
		fr.item09 = (EditText)view.findViewById(R.id.func_04_030_item09); 
		fr.item10 = (EditText)view.findViewById(R.id.func_04_030_item10); 
		fr.item11 = (EditText)view.findViewById(R.id.func_04_030_item11); 
		fr.item12 = (EditText)view.findViewById(R.id.func_04_030_item12); 
		fr.item13 = (EditText)view.findViewById(R.id.func_04_030_item13); 
		fr.item14 = (EditText)view.findViewById(R.id.func_04_030_item14); 
		fr.item15 = (EditText)view.findViewById(R.id.func_04_030_item15); 
		fr.item16 = (EditText)view.findViewById(R.id.func_04_030_item16); 
		fr.item17 = (EditText)view.findViewById(R.id.func_04_030_item17); 
		fr.item18 = (EditText)view.findViewById(R.id.func_04_030_item18); 
		fr.item19 = (EditText)view.findViewById(R.id.func_04_030_item19); 
		fr.item20 = (EditText)view.findViewById(R.id.func_04_030_item20); 
		fr.item21 = (EditText)view.findViewById(R.id.func_04_030_item21); 
		fr.item22 = (EditText)view.findViewById(R.id.func_04_030_item22); 
		fr.item23 = (EditText)view.findViewById(R.id.func_04_030_item23); 
		fr.item24 = (EditText)view.findViewById(R.id.func_04_030_item24); 
		fr.item25 = (EditText)view.findViewById(R.id.func_04_030_item25); 
		fr.item26 = (EditText)view.findViewById(R.id.func_04_030_item26); 
		fr.item27 = (EditText)view.findViewById(R.id.func_04_030_item27); 
		fr.item28 = (EditText)view.findViewById(R.id.func_04_030_item28); 
		fr.item29 = (EditText)view.findViewById(R.id.func_04_030_item29); 
		fr.item30 = (EditText)view.findViewById(R.id.func_04_030_item30); 
		fr.item31 = (EditText)view.findViewById(R.id.func_04_030_item31); 
		fr.item32 = (EditText)view.findViewById(R.id.func_04_030_item32); 
		fr.item33 = (EditText)view.findViewById(R.id.func_04_030_item33); 
		fr.item34 = (EditText)view.findViewById(R.id.func_04_030_item34); 
		fr.item35 = (EditText)view.findViewById(R.id.func_04_030_item35); 
	...
	public void setFilter(){
		...
		fr.item01.addTextChangedListener(new MyTextWatcher(Constant.func_vk_04_030_item_01));
		fr.item02.setFilters(new InputFilter[]{new InputFilter_DecimalUnSigned(5)});
		fr.item02.addTextChangedListener(new MyTextWatcher(Constant.func_vk_04_030_item_02));
		fr.item03.setFilters(new InputFilter[]{new InputFilter_DecimalUnSigned(5)});
		fr.item03.addTextChangedListener(new MyTextWatcher(Constant.func_vk_04_030_item_03));
		fr.item04.setFilters(new InputFilter[]{new InputFilter_DecimalUnSigned(5)});
		fr.item04.addTextChangedListener(new MyTextWatcher(Constant.func_vk_04_030_item_04));
		fr.item05.setFilters(new InputFilter[]{new InputFilter_NumberUnSigned(5)});
		fr.item05.addTextChangedListener(new MyTextWatcher(Constant.func_vk_04_030_item_05));
		fr.item06.setFilters(new InputFilter[]{new InputFilter_DecimalUnSigned(6)});
		fr.item06.addTextChangedListener(new MyTextWatcher(Constant.func_vk_04_030_item_06));
		fr.item07.setFilters(new InputFilter[]{new InputFilter_NumberUnSigned(3)});
		fr.item07.addTextChangedListener(new MyTextWatcher(Constant.func_vk_04_030_item_07));
		fr.item08.setFilters(new InputFilter[]{new InputFilter_DecimalUnSigned(8)});
		fr.item08.addTextChangedListener(new MyTextWatcher(Constant.func_vk_04_030_item_08));
		fr.item09.setFilters(new InputFilter[]{new InputFilter_DecimalUnSigned(6)});
		fr.item09.addTextChangedListener(new MyTextWatcher(Constant.func_vk_04_030_item_09));
		fr.item10.setFilters(new InputFilter[]{new InputFilter_DecimalUnSigned(7)});
		fr.item10.addTextChangedListener(new MyTextWatcher(Constant.func_vk_04_030_item_10));
		fr.item11.setFilters(new InputFilter[]{new InputFilter_DecimalUnSigned(6)});
		fr.item11.addTextChangedListener(new MyTextWatcher(Constant.func_vk_04_030_item_11));
		fr.item12.setFilters(new InputFilter[]{new InputFilter_DecimalUnSigned(8)});
		fr.item12.addTextChangedListener(new MyTextWatcher(Constant.func_vk_04_030_item_12));
		fr.item13.setFilters(new InputFilter[]{new InputFilter_DecimalUnSigned(7)});
		fr.item13.addTextChangedListener(new MyTextWatcher(Constant.func_vk_04_030_item_13));
		fr.item14.setFilters(new InputFilter[]{new InputFilter_DecimalUnSigned(6)});
		fr.item14.addTextChangedListener(new MyTextWatcher(Constant.func_vk_04_030_item_14));
		fr.item15.setFilters(new InputFilter[]{new InputFilter_DecimalUnSigned(8)});
		fr.item15.addTextChangedListener(new MyTextWatcher(Constant.func_vk_04_030_item_15));
		fr.item16.setFilters(new InputFilter[]{new InputFilter_DecimalUnSigned(8)});
		fr.item16.addTextChangedListener(new MyTextWatcher(Constant.func_vk_04_030_item_16));
		fr.item17.setFilters(new InputFilter[]{new InputFilter_DecimalUnSigned(8)});
		fr.item17.addTextChangedListener(new MyTextWatcher(Constant.func_vk_04_030_item_17));
		fr.item18.setFilters(new InputFilter[]{new InputFilter_DecimalUnSigned(8)});
		fr.item18.addTextChangedListener(new MyTextWatcher(Constant.func_vk_04_030_item_18));
		fr.item19.setFilters(new InputFilter[]{new InputFilter_DecimalUnSigned(6)});
		fr.item19.addTextChangedListener(new MyTextWatcher(Constant.func_vk_04_030_item_19));
		fr.item20.setFilters(new InputFilter[]{new InputFilter_DecimalUnSigned(8)});
		fr.item20.addTextChangedListener(new MyTextWatcher(Constant.func_vk_04_030_item_20));
		fr.item21.setFilters(new InputFilter[]{new InputFilter_DecimalUnSigned(6)});
		fr.item21.addTextChangedListener(new MyTextWatcher(Constant.func_vk_04_030_item_21));
		fr.item22.setFilters(new InputFilter[]{new InputFilter_DecimalUnSigned(6)});
		fr.item22.addTextChangedListener(new MyTextWatcher(Constant.func_vk_04_030_item_22));
		fr.item23.setFilters(new InputFilter[]{new InputFilter_DecimalUnSigned(6)});
		fr.item23.addTextChangedListener(new MyTextWatcher(Constant.func_vk_04_030_item_23));
		fr.item24.setFilters(new InputFilter[]{new InputFilter_DecimalUnSigned(6)});
		fr.item24.addTextChangedListener(new MyTextWatcher(Constant.func_vk_04_030_item_24));
		fr.item25.setFilters(new InputFilter[]{new InputFilter_NumberUnSigned(10)});
		fr.item25.addTextChangedListener(new MyTextWatcher(Constant.func_vk_04_030_item_25));
		fr.item26.setFilters(new InputFilter[]{new InputFilter_DecimalUnSigned(7)});
		fr.item26.addTextChangedListener(new MyTextWatcher(Constant.func_vk_04_030_item_26));
		fr.item27.setFilters(new InputFilter[]{new InputFilter_DecimalUnSigned(9)});
		fr.item27.addTextChangedListener(new MyTextWatcher(Constant.func_vk_04_030_item_27));
		fr.item28.setFilters(new InputFilter[]{new InputFilter_DecimalUnSigned(6)});
		fr.item28.addTextChangedListener(new MyTextWatcher(Constant.func_vk_04_030_item_28));
		fr.item29.setFilters(new InputFilter[]{new InputFilter_DecimalUnSigned(5)});
		fr.item29.addTextChangedListener(new MyTextWatcher(Constant.func_vk_04_030_item_29));
		fr.item30.setFilters(new InputFilter[]{new InputFilter_DecimalUnSigned(5)});
		fr.item30.addTextChangedListener(new MyTextWatcher(Constant.func_vk_04_030_item_30));
		fr.item31.setFilters(new InputFilter[]{new InputFilter_DecimalUnSigned(5)});
		fr.item31.addTextChangedListener(new MyTextWatcher(Constant.func_vk_04_030_item_31));
		fr.item32.setFilters(new InputFilter[]{new InputFilter_DecimalUnSigned(5)});
		fr.item32.addTextChangedListener(new MyTextWatcher(Constant.func_vk_04_030_item_32));
		fr.item33.setFilters(new InputFilter[]{new InputFilter_DecimalUnSigned(8)});
		fr.item33.addTextChangedListener(new MyTextWatcher(Constant.func_vk_04_030_item_33));
		fr.item34.setFilters(new InputFilter[]{new InputFilter_DecimalUnSigned(8)});
		fr.item34.addTextChangedListener(new MyTextWatcher(Constant.func_vk_04_030_item_34));
		fr.item35.setFilters(new InputFilter[]{new InputFilter_DecimalUnSigned(8)});
		fr.item35.addTextChangedListener(new MyTextWatcher(Constant.func_vk_04_030_item_35));		
	}
